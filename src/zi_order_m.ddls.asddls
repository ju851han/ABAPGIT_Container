...

{
  key order_uuid            as OrderUUID,
      ...
      //1 = Zeit ist valide
      case tims_is_valid(drop_off_time) when 1 then
        cast (drop_off_time as abap.tims)
      else '' end           as DropOffTime,
      desired_drop_off_date as DesiredDropOffDate,
      desired_drop_off_time as DesiredDropOffTime,
