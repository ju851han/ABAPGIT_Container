...
*   fill internal tables
   ...
   ( container_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) container_id = '3' max_payload = '26.48' payload_unit_of_measure = 't' available = 'X'  )
        ...
        it_order = VALUE #(
( order_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) order_id = '20' customer_id = '100' container_id = '2' category = 'EARTH&SOIL' price_per_t = '50' total_price = '125' currency_code = 'EUR' remarks = '' dest_city = 'Konstanz'
...
( order_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) order_id = '21' customer_id = '101' container_id = '1' category = 'WOOD' price_per_t = '100' total_price = '70' currency_code = 'EUR' remarks = '' dest_city = 'Marchegg'
...
( order_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) order_id = '22' customer_id = '100' container_id = '2' category = 'EARTH&SOIL' price_per_t = '50' total_price = '125' currency_code = 'EUR' remarks = '' dest_city = 'Konstanz'
dest_postal_code = '78462' dest_street = 'Alfred-Wachtel-Straße 8' dest_country_code = 'DE' status = 'O' delivery_date = '20210202' delivery_time = '170000' desired_drop_off_date = '20210202' desired_drop_off_time = '190000' drop_off_date = ''
drop_off_time = '' created_at = zv_tsl created_by = 'ADMIN' last_changed_at = zv_tsl last_changed_by = 'ADMIN' last_local_changed_at = zv_tsl  )
            ).
