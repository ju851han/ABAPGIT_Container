...
*   fill internal tables
   ...
   ( container_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) container_id = '3' max_payload = '26.48' payload_unit_of_measure = 't' available = 'X'  )
        ...
        it_order = VALUE #(
( order_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) order_id = '0' customer_id = '0' container_id = '2' category = 'EARTH&SOIL' price_per_t = '50' total_price = '125' currency_code = 'EUR' remarks = '' dest_city = 'Konstanz'
...
( order_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) order_id = '1' customer_id = '1' container_id = '1' category = 'WOOD' price_per_t = '100' total_price = '70' currency_code = 'EUR' remarks = '' dest_city = 'Marchegg'
...
( order_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) order_id = '2' customer_id = '0' container_id = '2' category = 'EARTH&SOIL' price_per_t = '50' total_price = '125' currency_code = 'EUR' remarks = '' dest_city = 'Konstanz'
...
drop_off_time = '190000' created_at = zv_tsl created_by = 'ADMIN' last_changed_at = zv_tsl last_changed_by = 'ADMIN' last_local_changed_at = zv_tsl  )
        ...
        it_customer = VALUE #(
( customer_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) customer_id = '0' first_name = 'Max' last_name = 'Mustermann' company_name = '' city = 'Wien' postal_code = '1010' street = 'Taborstraße 1' country_code = 'AT' created_at = zv_tsl
created_by = 'ADMIN' last_changed_at = zv_tsl last_changed_by = 'ADMIN' last_local_changed_at = zv_tsl  )
( customer_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) customer_id = '1' first_name = 'Tobias' last_name = 'Brendgens' company_name = 'HTWG Konstanz' city = 'Konstanz' postal_code = '78462' street = 'Alfred-Wachtel-Straße 8'
...
( customer_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) customer_id = '2' first_name = 'Susanne' last_name = 'Saner' company_name = '' city = 'Basel' postal_code = '4001' street = 'Austraße 3' country_code = 'CH' created_at = zv_tsl
created_by = 'ADMIN' last_changed_at = zv_tsl last_changed_by = 'ADMIN' last_local_changed_at = zv_tsl  )
       ).
