...
*   fill internal tables
   ...
   ( container_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) container_id = '3' max_payload = '26.48' payload_unit_of_measure = 't' available = 'X'  )
        ...
        it_order = VALUE #(
   ( order_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) order_id = '20' customer_id = '100' container_id = '2' category = 'EARTH&SOIL' price_per_t = '50' total_price = '125' currency_code = 'EUR' remarks = 'Ordered by Telephone'
dest_city = 'Konstanz' dest_postal_code = '78462' dest_street = 'Alfred-Wachtel-Straße 8' dest_country_code = 'DE' status = 'X' delivery_date = '20210101' delivery_time = '163000' desired_drop_off_date = '20210101' desired_drop_off_time = '163000'
drop_off_date = '20210101' drop_off_time = '163000' created_at = zv_tsl created_by = 'ADMIN' last_changed_at = zv_tsl last_changed_by = 'ADMIN' last_local_changed_at = zv_tsl  )
   ( order_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) order_id = '21' customer_id = '101' container_id = '1' category = 'WOOD' price_per_t = '100' total_price = '70' currency_code = 'EUR' remarks = 'Ordered by WhatsApp' dest_city =
'Marchegg' dest_postal_code = '2294' dest_street = 'Heimatland 2' dest_country_code = 'AT' status = 'X' delivery_date = '20210115' delivery_time = '140000' desired_drop_off_date = '20210115' desired_drop_off_time = '140500' drop_off_date = '20210115'
drop_off_time = '140500' created_at = zv_tsl created_by = 'ADMIN' last_changed_at = zv_tsl last_changed_by = 'ADMIN' last_local_changed_at = zv_tsl  )
   ( order_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) order_id = '22' customer_id = '100' container_id = '2' category = 'EARTH&SOIL' price_per_t = '50' total_price = '125' currency_code = 'EUR' remarks = 'Ordered by Telephone'
dest_city = 'Konstanz' dest_postal_code = '78462' dest_street = 'Alfred-Wachtel-Straße 8' dest_country_code = 'DE' status = 'O' delivery_date = '20210202' delivery_time = '170000' desired_drop_off_date = '20210202' desired_drop_off_time = '190000'
drop_off_date = '' drop_off_time = '' created_at = zv_tsl created_by = 'ADMIN' last_changed_at = zv_tsl last_changed_by = 'ADMIN' last_local_changed_at = zv_tsl  )
               ).
