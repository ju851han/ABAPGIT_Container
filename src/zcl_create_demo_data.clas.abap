...
*   fill internal tables
   ...
   ( container_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) container_id = '3' max_payload = '26.48' payload_unit_of_measure = 't' available = 'X'  )
        ...
        it_order = VALUE #(
( order_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) order_id = '1' customer_id = '2' container_id = '2' category = 'EARTH&SOIL' price_per_t = '50' total_price = '125' currency_code = 'EUR' remarks = '' dest_city = 'Konstanz'
...
( order_uuid = NEW cl_system_uuid( )->if_system_uuid~create_uuid_x16( ) order_id = '3' customer_id = '2' container_id = '2' category = 'EARTH&SOIL' price_per_t = '50' total_price = '125' currency_code = 'EUR' remarks = '' dest_city = 'Konstanz'
